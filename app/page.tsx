      ...
      <section className="py-20 bg-gradient-to-br from-teal-50 via-orange-50 to-white relative overflow-hidden">
        ...
        <div className="container px-4 md:px-6">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-6 bg-gradient-to-r from-[#FF6B35] to-[#4ECDC4] bg-clip-text text-transparent animate-fade-up">
              Start Building Your Future, for Free
            </h2>
            <p className="text-xl text-[#2C3E50]/80 mb-8 animate-fade-up">
